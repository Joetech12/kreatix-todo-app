...
const style = {
  ...
  row: `flex`,
  text: `ml-[10px] cursor-pointer font-bold text-[17px]`,
  text2: `ml-[10px] cursor-pointer font-semibold text-[15px]`,
  text3: `ml-[10px] text-[14px] cursor-pointer`,
  textComplete: `ml-[10px] cursor-pointer line-through font-bold`,
  textComplete2: `ml-[10px] cursor-pointer line-through font-semibold`,
